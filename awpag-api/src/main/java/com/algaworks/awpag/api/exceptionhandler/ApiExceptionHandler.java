...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		problemDetail.setType(URI.create("https://algawors.com/erros/campos-invalidos"));
	...
	public ProblemDetail handleNegocio(NegocioException e) {
		...
		problemDetail.setType(URI.create("https://algawors.com/erros/regra-de-negocio"));
	...
	public ProblemDetail handleDataIntegrityViolation(DataIntegrityViolationException e) {
		...
		problemDetail.setType(URI.create("https://algawors.com/erros/recurso-em-uso"));
